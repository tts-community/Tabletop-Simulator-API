Objects can be spawned by any script using the [spawnObject()](scripting/base.md#spawnobject) function. These are the `type` Strings used to designate the type of Object to spawn.
