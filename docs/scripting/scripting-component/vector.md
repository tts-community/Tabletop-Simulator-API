...
[<span class="ret boo"></span>](scripting/types.md)&nbsp;Returns true if two vectors are approximately equal.
...
[<span class="ret vec"></span>](scripting/types.md)&nbsp;Return a cross-product vector of two vectors.
