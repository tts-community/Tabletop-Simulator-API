...
-- | -- | -- | --
[<span class="tag nil"></span>](scripting/types.md)&nbsp;| nil | No value. | `#!lua nil`
[<span class="tag int"></span>](scripting/types.md)&nbsp;| int | Non-decimal value. | `#!lua 5`
[<span class="tag flo"></span>](scripting/types.md)&nbsp;| float | Non-exact decimal value. | `#!lua 2.032`
[<span class="tag boo"></span>](scripting/types.md)&nbsp;| bool | `true` or `false` value. | `#!lua true`
[<span class="tag str"></span>](scripting/types.md)&nbsp;| string | A series of characters. | `#!lua "Hello."`
[<span class="tag tab"></span>](scripting/types.md)&nbsp;| table | A container with keys and values. | `#!lua {["key"]="value", true, 5}`
[<span class="tag obj"></span>](scripting/types.md)&nbsp;| object | An in-game physical Object. Sometimes Global. | `#!lua Global or self`
[<span class="tag pla"></span>](scripting/types.md)&nbsp;| player | An in-game Player. | `#!lua Player["White"]`
[<span class="tag var"></span>](scripting/types.md)&nbsp;| variable | A combination of other types. |
...
You are also able to use a String in place of a color table. Using a [Player Color](player-scripting/scripting-component/player-color.md) will automatically fill in that value. It works with any of the 12 color names, as they are written on the [Player Color](player-scripting/scripting-component/player-color.md) page.
...
You can use the [Vector](scripting/scripting-component/vector.md) class to manipulate vectors.
...
As an example, An Object at coordinate X=5, Y=2, Z=-1 would return this [`Vector`](scripting/scripting-component/vector.md):
``` Lua
{
    x=5, y=2, z=-1,
}
...
???tip "Conversion Between World/Local"
     [positionToWorld(...)](scripting/game-object/object.md#positiontoworld) and [positionToLocal(...)](scripting/game-object/object.md#positiontolocal) can be used to convert between the two types.
...
As an example, here is [Wait.frames(...)](scripting/scripting-component/wait.md#frames) used 3 times. It waits a set number of frames and then activates a given function:
