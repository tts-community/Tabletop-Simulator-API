...
spawnObject([<span class="tag tab"></span>](types.md)&nbsp;parameters) | Spawns an Object. View the [Build-in Object](built-in-object.md) or [Custom Game Objects](custom-game-objects.md) pages for Objects that can be spawned. | [<span class="ret obj"></span>](types.md) | [<span class="i"></span>](#spawnobject)
...
[<span class="ret obj"></span>](types.md)&nbsp;Spawn an Object. View the [Build-in Object](built-in-object.md) or [Custom Game Objects](custom-game-objects.md) pages for Objects that can be spawned.
...
!!!info "spawnObject(parameters)"
	* [<span class="tag tab"></span>](types.md) **parameters**: A Table of parameters used to determine how spawnObject will act.
		* [<span class="tag str"></span>](types.md) **parameters.type**: [Build-in Object](built-in-object.md) or [Custom Game Objects](custom-game-objects.md) type.
